...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Kanak\\OneDrive\\pschopy_LAB PSYCHOLOGY\\WORD PRIMING EXPERIMENT\\WORD PRIMING EXPERIMENT_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/Kanak/OneDrive/pschopy_LAB PSYCHOLOGY/STUDY_WORDS.xlsx'), 
        seed=None, 
    )
    ...
    trials_2 = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('C:/Users/Kanak/OneDrive/pschopy_LAB PSYCHOLOGY/test_words.xlsx'), 
        seed=None, 
    )
