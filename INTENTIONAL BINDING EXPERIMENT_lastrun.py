...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Kanak\\OneDrive\\pschopy_LAB PSYCHOLOGY\\INTENTIONAL BINDING EXP\\INTENTIONAL BINDING EXPERIMENT_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    polygon_2 = visual.ShapeStim(
        ...
        ori=0.0, pos=(0, 0), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor=[-0.9294, 0.0039, -1.0000],
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('IB_CONDITIONS FILE.xlsx'), 
        seed=None, 
    )
    ...
    # completed 19.0 repeats of 'trials'
