...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Kanak\\OneDrive\\pschopy_LAB PSYCHOLOGY\\VISUAL SEARCH EXPERIMENT\\Visual search experiment_lastrun.py',
    ...
    for thisTrial in trials:
        ...
        for i in range(num_distr):
            distr = visual.TextStim(
                ...
                text='L',
                font='Open Sans',
                pos=(random() - 0.5, random() - 0.5),  # Random spread
                wrapWidth=None,
                height=0.1,
                ori=randint(1, 360),
                color='white',
